        ...
        try{
            ...
            for(ScoreDoc scoreDoc : hits.scoreDocs) {
                ...
                if(p.equals(nameArticle)){
                    ...
                    if(index!=-1){
                        //System.out.println("Value: "+ doc.get("page")+ doc.get("value"));
                        //hashMapInterLanguageLink.put(com.vietnamesedbpedia.dbpedia.Language.getLanguages().get(index),doc.get(com.vietnamesedbpedia.dbpedia.Constants.VALUE));
                        ...
                        //searchType.searchType(doc.get(com.vietnamesedbpedia.dbpedia.Constants.VALUE));
                    }
                }
            }
        }catch (Exception e){
