...
public class Constants {
    //folder contain DBpedia dumps in en, de, nl
    public static final String DBPEDIA_DUMPS_EN = "";
    public static final String DBPEDIA_DUMPS_DE = "";
    public static final String DBPEDIA_DUMPS_NL = "";

    //folder contain index after extract from DBEPDIA DUMPS
    public static final String INDEX_DBPEDIA_DUMPS_EN = "";
    public static final String INDEX_DBPEDIA_DUMPS_DE = "";
    public static final String INDEX_DBPEDIA_DUMPS_NL = "";

    //folder contain all interlanguage link in vi, en, de, nl
    public static final String INTERLANGUAGELINK_DUMPS_VI = "";
    public static final String INTERLANGUAGELINK_DUMPS_EN = "";
    public static final String INTERLANGUAGELINK_DUMPS_DE = "";
    public static final String INTERLANGUAGELINK_DUMPS_NL = "";

    //folder contains index after extract from Interlangua link dumps
    public static final String INDEX_INTERLANGUAGELINK_DUMPS_VI = "";
    public static final String INDEX_INTERLANGUAGELINK_DUMPS_EN = "";
    public static final String INDEX_INTERLANGUAGELINK_DUMPS_DE = "";
    public static final String INDEX_INTERLANGUAGELINK_DUMPS_NL = "";
...
//    public static final
    ...
    public static final String ONTOLOGY_2016 = "dbpedia_3.9.owl";
