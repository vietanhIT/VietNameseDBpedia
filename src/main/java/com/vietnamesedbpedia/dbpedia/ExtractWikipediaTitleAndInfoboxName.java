...
//                            sb.append(title);
//                            sb.append(" ");
//                            sb.append(com.vietnamesedbpedia.dbpedia.WikipediaParseTemplateName.nameTemplate(text).replace(" ","_"));
                            titleIdWriter.println(title);
//                            sheet.addCell(new Label(0,i,title));
                            //sheet.addCell(new Label(1,i,com.vietnamesedbpedia.dbpedia.WikipediaParseTemplateName.nameTemplate(text).replace(" ","_")));
