...
public class TranslateDemo {
    ...
    private static void parseSourcePropertyFromServer() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document document = Jsoup.connect("http://mappings.com.vietnamesedbpedia.dbpedia.org/server/ontology/classes/Settlement")
...
//        Logger logger = Logger.getLogger(com.vietnamesedbpedia.dbpedia.TranslateDemo.class);
//        com.vietnamesedbpedia.dbpedia.TranslateDemo.parseSourcePropertyFromServer();
...
//        new com.vietnamesedbpedia.dbpedia.TranslateDemo().splitString("demographicsAsOf");
    }
