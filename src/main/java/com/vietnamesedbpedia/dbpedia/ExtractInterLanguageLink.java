...
public class ExtractInterLanguageLink {
...
//        Logger logger = Logger.getLogger(ExtractInterLanguageLink.class.getName());
        private int count = 0;
...
//        Logger logger= Logger.getLogger(ExtractInterLanguageLink.class.getName());
        //logger.debug("hello");
        ArrayList<String> interLanguageLinkDumps = new ArrayList<>();
        interLanguageLinkDumps.add("vidump");
        interLanguageLinkDumps.add("endump");
        interLanguageLinkDumps.add("dedump");
        interLanguageLinkDumps.add("nldump");

        ArrayList<String> interLanguageLinkDumpIndexs = new ArrayList<>();
        interLanguageLinkDumpIndexs.add("index-vi");
        interLanguageLinkDumpIndexs.add("index-en");
        interLanguageLinkDumpIndexs.add("index-de");
        interLanguageLinkDumpIndexs.add("index-nl");

        ExtractInterLanguageLink extractInterLanguageLink = new ExtractInterLanguageLink();
        for(int i=0; i<interLanguageLinkDumps.size(); i++){
            extractInterLanguageLink.extractAndIndex(interLanguageLinkDumps.get(i), interLanguageLinkDumpIndexs.get(i));
        }
    }
